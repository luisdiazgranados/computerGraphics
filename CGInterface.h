...
// Stub classes when NVIDIA Cg toolkit is not available (e.g. macOS)
class CGInterface {
public:
	CGInterface() {}
	void PerSessionInit() {}
...
public:
	ShaderOneInterface() {}
	bool PerSessionInit(CGInterface *) { return false; }
	void BindPrograms() {}
	void PerFrameInit() {}
...
class ShaderOneInterface {
  ...
  CGparameter vertexOCenter; // center of the object
  CGparameter vertexSRadius;
  CGparameter vertexMFraction;
  CGparameter geometryModelViewProj; // geometry shader
  CGparameter fragmentEye, fragmentV0, fragmentV1, fragmentV3;
public:
  ShaderOneInterface() {};
